...
import io.kinny.login.auth.Authentication;
import io.kinny.login.auth.ApiKeyAuth;
import io.kinny.login.auth.HttpBasicAuth;
import io.kinny.login.request.GetRequest;
import io.kinny.login.request.PostRequest;
import io.kinny.login.request.PutRequest;
import io.kinny.login.request.DeleteRequest;
import io.kinny.login.request.PatchRequest;
